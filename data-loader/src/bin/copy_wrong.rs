...
fn main() -> Result<()> {
    ...
    let pgn_path = "./dataset/lichess_db_standard_rated_2016-05.pgn"; // Replace with the path to your PGN file
    let index_path = "./dataset/index.txt"; // Replace with the path to your PGN file
    let output_path = "./dataset/extracted_lines.txt"; // The path where the extracted lines will be saved

    let games = read_games(pgn_path, index_path, start_index, end_index)?;
